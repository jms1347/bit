...
function loadGoodsList(pageNo, orderBy, category, code, name) {
	...
	$.getJSON('../json/delivery/list.do?pageNo=' + pageNo, 
	function(data) {
...
function loaddelivery(deliveryNo) {
	$.getJSON('../json/delivery/view.do?no=' + deliveryNo, 
			function(data){
		$('#btnCancel').click();
...
function deleteGoods(goodsNo) {
	$.getJSON('../json/delivery/delete.do?no=' + goodsNo, 
			function(data){
