 ...
 *  
 * 방법 : 
 * 	1) 어떤 스레드가 크리티컬 세션에 집ㄴ입하면 잠근다(lock)
 ...
 * 
 * 여러 스레드가 진입하더라도 계싼에 영향을 끼치지 않는 코드블록
 * 	-> Thread safe (스레드가 안전하다)
 * 	-> 동기화 처리를 할 필요가 없다.
 */
package thread;
...
public class Test05 {
	...
	static class Account{
		...
		// 여러 스레드가 동시에 접근 했을 때 문제가 발생하는 코드 블록
